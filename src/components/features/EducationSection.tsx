        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-2">Master of Science - 2018</p>
              <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">DePaul University</p>
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-2">Bachelor of Arts - 2008</p>
              <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">Chicago State University</p>
              <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
