...
export const CaseStudyCard: React.FC<CaseStudyCardProps> = ({ 
  ...
  if (study.comingSoon) {
    return (
      <div className={`bg-slate-800/40 border border-slate-700 rounded-xl overflow-hidden hover:border-slate-600 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group relative cursor-not-allowed opacity-75 ${featured ? 'md:col-span-1' : ''}`}>
